...
class InitReportCommand extends ContainerAwareCommand {
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
    ...
    if ($srcClassName = $input->getOption('copy')) {
      ...
      $ext->builders['report.php'] = new Template('CRMCivixBundle:Code:report.php.php', $phpFile, FALSE, $this
        ->getContainer()->get('templating'));
      $ext->builders['page.tpl.php'] = new Template('CRMCivixBundle:Code:report.tpl.php', $tplFile, FALSE, $this
        ->getContainer()->get('templating'));
    }
